<?php    
    ...
    if($_POST["tipo"]=="g"){
        ...
        pg_query("insert into usuario values('$cont','$codigo','$_POST[nombre_user]','$_POST[dir_user]','$_POST[ciudad_user]','$_POST[tel_user]','$_POST[cel_user]','$_POST[mail_user]','$_POST[tipo_user]','$_POST[user_name]','','$_POST[institucion]','$_POST[categoria_user]','$_POST[departamento_user]','$_POST[tipo_sangre_user]','$_POST[fecha_nacimiento]','$_POST[sexo]','$_POST[estado_civil]')");       
        ////auditoria//
        $sql_audi=pg_query("select id_usuario,cod_usuario,nombres_usuario,direccion_usuario,nombre_ciudad,telefono_usuario,celular_usuario,email_usuario,nombre_tipo,nick_usuario,fecha,institucion,nombre_categoria,nombre_departamento,tipo_sangre,fecha_nacimiento,sexo,estado_civil from usuario,ciudad,tipo_usuario,categorias,departamento where usuario.id_ciudad=ciudad.id_ciudad and usuario.id_tipo_user=tipo_usuario.id_tipo_usuario and categorias.id_categoria=usuario.id_categoria and usuario.id_departamento=departamento.id_departamento and usuario.id_usuario='$cont' order by id_usuario asc");
        while ($row_audi=pg_fetch_row($sql_audi)) {
            $nuevo=$row_audi[0].",".$row_audi[1].",".$row_audi[2].",".$row_audi[3].",".$row_audi[4].",".$row_audi[5].",".$row_audi[6].",".$row_audi[7].",".$row_audi[8].",".$row_audi[9].",".$row_audi[10].",".$row_audi[11].",".$row_audi[12].",".$row_audi[13].",".$row_audi[14].",".$row_audi[15].",".$row_audi[16].",".$row_audi[17];
            $temp=$row_audi[2];            
        }            
    ...
    if($_POST["tipo"]=="m"){    
        ...
        while ($row_audi=pg_fetch_row($sql_audi)) {
            $anterior=$row_audi[0].",".$row_audi[1].",".$row_audi[2].",".$row_audi[3].",".$row_audi[4].",".$row_audi[5].",".$row_audi[6].",".$row_audi[7].",".$row_audi[8].",".$row_audi[9].",".$row_audi[10].",".$row_audi[11].",".$row_audi[12].",".$row_audi[13].",".$row_audi[14].",".$row_audi[15].",".$row_audi[16].",".$row_audi[17];               
        }            
        //////////////  
        pg_query("update usuario set id_usuario='$_POST[id_user]',cod_usuario='$_POST[cod_user]',nombres_usuario='$_POST[nombre_user]',direccion_usuario='$_POST[dir_user]',id_ciudad='$_POST[ciudad_user]',telefono_usuario='$_POST[tel_user]',celular_usuario='$_POST[cel_user]',email_usuario='$_POST[mail_user]',id_tipo_user='$_POST[tipo_user]',nick_usuario='$_POST[user_name]',institucion='$_POST[institucion]',id_categoria='$_POST[categoria_user]',id_departamento='$_POST[departamento_user]',tipo_sangre='$_POST[tipo_sangre_user]',fecha_nacimiento='$_POST[fecha_nacimiento]',sexo='$_POST[sexo]',estado_civil='$_POST[estado_civil]' where id_usuario='$_POST[id_user]'");
        ////auditoria//
