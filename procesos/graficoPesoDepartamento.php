...
$lista2;
$contador=0;
$sql=pg_query("select id_departamento,nombre_departamento from departamento");
while($row1=pg_fetch_row($sql)){
	$result = pg_query("SELECT fecha_cambio,peso FROM bitacora where id_departamento='$row1[0]' and fecha_cambio between '$fecha1' and '$fecha2'");
