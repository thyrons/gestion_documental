<?php
    ...
    $id_audi=$id_audi+1;    
    ////auditoria//                
    pg_query("insert into auditoria_sistema values ('$id_audi','$_SESSION[usuario] $_SESSION[id]','$fecha','','Descarga de archivos','','','Descarga del documento(bitacora) por el usuario $_SESSION[nombres]')");        
    //////////////  
	$result=pg_query($sql);
	/**/	
