...
<script type="text/javascript" src="../librerias/doc_enviados.js"></script> 
...
<div id='frmProcesos' title="Procesos">                                          
        ...
        <br><br>      
        <a href="#" id="btnModificar" class="button glow button-rounded button-flat-action"><i class="fa fa-edit"></i> Modificar Archivo</a>                                               
</div> 